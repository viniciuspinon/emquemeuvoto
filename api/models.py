...
class PesquisaEleitoralItem(BaseModel):
    ...
    total_pesquisas: Optional[int] = None
    fonte: Optional[str] = None


class PesquisaPonto(BaseModel):
    data: str
    media_ponderada_pct: float


class PesquisaPresidenciaCandidato(BaseModel):
    sq_candidato: Optional[str] = None
    candidato: str
    partido: str
    posicao_ranking: Optional[int] = None
    media_atual: float
    pontos: List[PesquisaPonto] = []


class PesquisaPresidenciaResponse(BaseModel):
    periodo: str
    total_pesquisas: int
    fonte: str
    data_atualizacao: Optional[str] = None
    series: List[PesquisaPresidenciaCandidato] = []


class PesquisaGovernadorItem(BaseModel):
    sq_candidato: Optional[str] = None
    uf: str
    estado: str
    macro_regiao: str
...
class PesquisaGovernadorHistoricoResponse(BaseModel):
    uf: str
    estado: str
    macro_regiao: Optional[str] = None
    periodo: str
    total_pesquisas: int
    fonte: str
    data_atualizacao: Optional[str] = None
