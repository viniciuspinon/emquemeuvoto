...
## ⚖️ Isenção Institucional, Rigor Metodológico & Fontes Oficiais

- **Isenção Institucional e Compromisso Cívico**: O projeto não possui filiação partidária, financiamento político ou vínculo com candidatos ou coligações.
- **Fontes Oficiais**:
